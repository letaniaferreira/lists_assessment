...
#found enumerate function of overstackflow (https://stackoverflow.com/questions/11475748/loop-through-list-with-both-content-and-index), but had to print them outside of tuples.
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    for food in foods1_set & foods2_set:
        common_list.append(food)
    lst_sorted = sorted(common_list)
    return lst_sorted
